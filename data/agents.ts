import type { Agent, Category, PricingPlan } from '../types'
...
export const pricingPlans: PricingPlan[] = [
  {
    ...
    features: ['دسترسی به تمام دستیارها', '۵ درخواست رایگان در ماه', 'پشتیبانی معمولی', 'خروجی پایه'],
